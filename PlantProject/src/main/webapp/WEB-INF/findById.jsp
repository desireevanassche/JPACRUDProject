...
<body>
				...
				<li class="nav-item dropdown"><a
					...
					<div class="dropdown-menu" aria-labelledby="navbarDropdown">
						...
						<a class="dropdown-item" href="idSearch.do">Search by ID</a> <a
							...
							class="dropdown-item" href="updateForm.do">Update an Entry</a>
					</div></li>
	...
	<main class="container-fluid">
		...
		<section id="searchBar" class="gridLayout">
			<div class="home-container" data-aos="fade-in">
				...
				<div class="row no-gutters">
					...
					<img src="https://live.staticflickr.com/65535/52005153928_c5fb70a4eb_c.jpg" width="516" height="640">
					...
					<div class="col2" id="rightSide">
						...
						<input type="text" name="pid" placeholder="Enter Plant ID"/> <input type="submit"
								value="Show Plant" />
						</form>
